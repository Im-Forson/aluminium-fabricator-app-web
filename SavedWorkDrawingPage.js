...
import { View, Pressable, Text, StyleSheet, ScrollView, Dimensions, Image } from "react-native";
import { useNavigation } from "@react-navigation/native";
import { AlufappContext } from "./alufapp-context";

function SavedWorkDrawingPage({ route }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView style={{paddingHorizontal: 10, height: '70vh'}}>
...
export default SavedWorkDrawingPage;
